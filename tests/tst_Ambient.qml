...
TestCase {
    ...
    function test_density_reveals_context() {
        ...
        verify(String(previous.icon.source).endsWith("/tettegouche/skip-back.svg"));
        verify(String(toggle.icon.source).endsWith("/tettegouche/pause.svg"));
        verify(String(next.icon.source).endsWith("/tettegouche/skip-forward.svg"));
